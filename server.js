...
const spotify_bot = require('./spotify_bot.js');
const spotify_api = require('./spotify_bot.js');
...
// I DON'T KNOW IF WE CAN USE REQ AND RES IN A MODULE <---
